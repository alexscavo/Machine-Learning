...
if __name__ == '__main__':
    ...
    print('Multiclass - S2 - Accuracy: %.2f%%' % (compute_accuracy(S2_predictions, labelsEval)*100))
    ...
    print('Binary (From multiclass) - S2 - Accuracy: %.2f%%' % (compute_accuracy(P, labelsEval)*100))
    ...
    print('Binary [inferno vs paradiso] - S2 - Accuracy: %.2f%%' % (compute_accuracy(S2_predictions, labelsEval)*100))
