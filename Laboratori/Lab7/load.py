...
def load_data():
    ...
    f=open('Lab6/inferno.txt', encoding="ISO-8859-1")
    ...
    f=open('Lab6/purgatorio.txt', encoding="ISO-8859-1")
    ...
    f=open('Lab6/paradiso.txt', encoding="ISO-8859-1")
...
def split_data(l, n):
    ...
    for i in range(len(l)):
        if i % n == 0:  # prendo 1 sample ogni 4
            lTest.append(l[i])
        else:
            lTrain.append(l[i])
